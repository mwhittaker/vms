...
JAVA_HOME="$HOME/jdk1.7.0_$JAVA_VERSION" PATH="$JAVA_HOME/bin:$PATH" jdk1.7.0_$JAVA_VERSION/bin/java -Dvim.files=/home/vagrant/.vim -Declipse.home=/home/vagrant/eclipse -jar eclim_2.5.0.jar install
