...
main() {
    ...
    wget 'http://mirror.reverse.net/pub/apache/maven/maven-3/3.5.3/binaries/apache-maven-3.5.3-bin.tar.gz'
    tar -xzvf apache-maven-3.5.3-bin.tar.gz
    echo 'export PATH="$PATH:$HOME/install/apache-maven-3.5.3/bin"' >> ~/.bash_path
    ...
    cd nailgun
    ../apache-maven-3.5.3/bin/mvn clean install
    make
    sudo make install
    cd ..
